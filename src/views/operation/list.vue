<template>
    <div class="add">
        ...
        >
         <template #nav-left> 
           <div class="icon">
            <van-icon name="arrow-left" size="18" @click="router.back()" style="padding:12px 0 0 12px"/>
           </div>
         </template> 
        <van-tab title="支出">
            <van-cell-group>
        ...
        <div class="add-pic" >
            <img :src="require('@/assets/img/add.png')" width="64" @click="router.push('/operation/edit')"/>
        </div>
    </div>
</template>
